...
#Define A_TES   		RetPosArr(aHeader, "UB_TES"		, 1) // Data de Entrega...
...
*******************************************************************************
	...
	//| Mensagem RODAPE
	aMens[M_RODAPE] := Padc('[ Emitido em '+Dtoc(dEmisOrc)+' - Proposta Válida por 2 Dias - Será Acrescida Despesa Bancária por Duplicata ]',120)
