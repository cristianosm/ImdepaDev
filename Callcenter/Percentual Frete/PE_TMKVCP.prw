...
*/
User Function TMKVCP(cCodTransp,oCodTransp,cTransp,oTransp,cCob,oCob,cEnt,oEnt,;
		cCidadeC,oCidadeC,cCepC,oCepC,cUfC,oUfC,cBairroE,oBairroE,cBairroC,oBairroC,cCidadeE,oCidadeE,;
		cCepE,oCepE,cUfE,oUfE,nOpc,cNumTlv,cCliente,cLoja,cCodPagto)
...
// Atualiza o codigo da condicao de pagamento
	IF !EMPTY(cCodPagto)
		...
		IF lOk
			RunTrigger(3,nil,nil,,PADR('UA_CONDPG',03))
		ENDIF

                //U_GTMKVFIM()
		RunTrigger(3,nil,nil,,PADR('UB_PRODUTO',03))
	ENDIF
...
//CRIS ASDADAS./D,AS/D.,AS/.D,A/S.D,ASD
