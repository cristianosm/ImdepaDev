...
*******************************************************************************
	...
	If Len( aDados ) == 0
		Aviso( "Orçado X Ofertado", "O Filtro não Retornou Dados", {"Ok"} )
		Return()
	Endif
...
*****************************************************************************************
	...
	DEFINE MSDIALOG oDlg TITLE "Orçado X Ofertado" FROM 000,000 TO 500,900 PIXEL

	@ 005,005 LISTBOX oLbx FIELDS HEADER ;
		""                   , OemToAnsi("Filial"), OemToAnsi("Cliente"), OemToAnsi("Orçamento"),;
		OemToAnsi("Produto"), OemToAnsi("Qtde. Orçado"), OemToAnsi("Qtde. Ofertado"),;
		OemToAnsi("Valor Ofertado"), OemToAnsi("Data / Hora" ), OemToAnsi("Preço");
	...
	@ 222,005 SAY "Ordenação:"             SIZE  65, 8 PIXEL OF oDlg
...
*****************************************************************************************
	...
	If aDados[ nPos, POS_MARCADO ]
		...
		DEFINE MSDIALOG oDlg1 TITLE "Alteração" FROM 000, 000  TO 150, 150 PIXEL
...
*******************************************************************************
	...
	If nQtde <= 0
		MsgInfo( "Não foram selecionados nenhum registro para alteração." )
		Return
	EndIf

	If MsgYesNo( "Confirma a atualização do Orçado X Ofertado ?", "Atualização" )
...
//					ZA0->ZA0_VOFERT := aDados[ _i, POS_VOFERT ]
					MsUnlock()
				Else
					MsgInfo( "Não foi possível alterar o Atendimento: " + aDados[ _i, POS_NUMORC ] )
				...
				Else
					MsgInfo( "Não foi possível gravar log do Atendimento: " + aDados[ _i, POS_NUMORC ] )
...
*******************************************************************************
	...
	aAdd(aPerg,{ "Do Orçamento ?"	,"Do Orçamento ?" ,"Do Orçamento ?" ,"mv_ch5","C", 6,0,0,"G",""		  ,"mv_par05","","","","","","","","","","","","","","","","","","","","","","","","",""   ,"","" })
	aAdd(aPerg,{ "Ate Orçamento ?"	,"Ate Orçamento ?","Ate Orçamento ?","mv_ch6","C", 6,0,0,"G","NaoVazio()","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","",""   ,"","" })
