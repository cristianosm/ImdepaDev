						...
						Else
							...
							ELSE
								...
								Else
									cFilDev := xFilial("SD2")
								EndIf
								if !(SF4->F4_AJUSTE=='S' .and. ((cAliasSD1)->D1_TIPO == "D")) .and. cSpecie <> 'NFCE'
...
/////quando nf entrada importacao
	...
	If lImporta_Imd
		...
		*/
		...
		If !EMPTY(nValPIS_Imd)
			cMCli_imd += " PIS: " + STR(nValPIS_Imd,12,2)
		EndIf

		If !EMPTY(nValCOF_Imd)
			cMCli_imd += " COFINS: " + STR(nValCOF_Imd,12,2)
		EndIf
	EndIf
...
//Geracao do arquivo XML
	...
	//*************************************************************************
	//Cristiano Machado...Monta Cuztomizações Imdepa no Xml
	If lMoXML_Imd /// Get(IM_LXMLIMD)
		U_AltXmlnfe(@cString, cTipo, cSerie, cNota, cClieFor, cLoja)
	EndIF
	//*************************************************************************
...
Return(cRet)
*********************************************************************
Static Function NfeTag(cTag,cConteudo)// Cristiano
*********************************************************************
	Local cRetorno := ""

//If NfeTag == '<cPais>'
//	Alert('Tag cPAIS: '+ cValToChar(cConteudo) )
//EndIf
...
//If NfeTag == '<cPais>'
//	Alert('cRetorno: '+ cValToChar(cRetorno) )
//EndIf
