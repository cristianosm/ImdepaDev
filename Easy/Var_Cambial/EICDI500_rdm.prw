...
*******************************************************************************
	...
	cUpdt := " Update SE2010 Set E2_TXMDCOR = "+cValToChar(SW6->W6_TX_VCAM)+", "
	cUpdt += " E2_DTVARIA 			= '"+Dtos(SW6->W6_DTCTEMB)+"' "
...
// MANTER E2_EMIS1 = DATA CONTABILIZACAO ORIGINAL....
