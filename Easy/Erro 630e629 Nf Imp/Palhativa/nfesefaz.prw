...
*/
			    ...
			    ////////////////////////////////////////////////////////////////FIM TRATAMENTO DE CODIGO E DESCRICAO DO PRODUTO
					...
					aadd(aProd,	{Len(aProd)+1,;
						...
						SB1->B1_UM,;
						(cAliasSD1)->D1_QUANT,;
						IIF(!(cAliasSD1)->D1_TIPO$"IP", (cAliasSD1)->D1_QUANT * NoRound( (cAliasSD1)->D1_VUNIT,4),0 ),; //(cAliasSD1)->D1_TOTAL,0),;
...
//cString += '<ean>'+ConvType(aProd[03])+'</ean>'
	...
	cString += '<vUnCom>'+ IIf(cF2Tipo == "C",ComplPreco(cTipo,cF2Tipo,aProd),ConvType(aProd[16],21,4))+'</vUnCom>'
...
///26/01/2012
	...
	cString += '<qTrib>' + ConvType(aProd[12], 15, Min(IIf(cTipo == "0", TamSX3("D1_QUANT")[2], TamSX3("D2_QUANT")[2]), 4)) + '</qTrib>'
                                                                                                          ///era 8
	cString += '<vUnTrib>'+ IIf(cF2Tipo == "C",ComplPreco(cTipo,cF2Tipo,aProd),ConvType(aProd[16],21,4))+'</vUnTrib>'
