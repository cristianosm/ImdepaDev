...
Local cBcc		:= ""
Local cSubject	:= "Arquivo CSV Ocupacao EndereÁos..."
...
Local aHelpPor03	:= {'Informar o Codigo do EnreÁo que deve ser ', 'avaliado. Para todos preencher com      ' , '"ZZZZZZZZZZZZZZZ".'	}
Local aHelpPor04	:= {'Informar Email que ira receber relatÛrio' , 'Exemplo: "fulano@dominio.com.br".       ' , ' '				}
