...
User Function PreNotaXML
    ...
    ///
    PUBLIC CASSUNTO:="V3.00 - VALIDACAO USUARIO - "
	...
	Do While .T.
		...
		*/
		...
		IF LPRODSNE
			...
			cCABECEM:='V2.01 - Relacao de Pedidos/Produtos na nota n„o encontrado!"
			cCorpo01:=''
		...
		For ni := 1 To Len(aPedIte)
			...
			CGCTIN:="56990880000145#56990880000811#56990880000730'
						...
						If !Empty(TC9->T9_QTDE) .AND. LSALDO .AND. LENCERRA
							...
							*/
							...
							IF aItens[nItem,3,2] > TC9->T9_QTDE
								...
								//nPC    := aItens[nItem,8,2] + ' / ' + aItens[nItem,9,2]
								nPC    := aNPC[AITEN,1] + ' / ' + aItens[nItem,9,2]  //aItens[nItem,7,2] + ' / ' + aItens[nItem,8,2]
...
Static Function Monta_TC9()
	...
	While CAD->(!EOF())
		...
		//SHEFFLER
		//57000036001407
		CGCSHF:="56993157000110#57000036001407#5700003600140X"
		CGCTIN:="56990880000145#56990880000811#56990880000730"
