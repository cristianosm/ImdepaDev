...
*********************************************************************
	...
	cSql += "from "
	cSql += "	sa2010 sa2, "
	cSql += " (	select fig_cnpj, fig_vencto, fig_valor,r_e_c_n_o_ from fiG010 where fig_filial = '  ' and fig_concil = '2' and fig_vencto >= '"+DToS(dDataBase-365)+"' and d_e_l_e_t_ = ' ' ) fig,  "
	cSql += "	se2010 se2 "
