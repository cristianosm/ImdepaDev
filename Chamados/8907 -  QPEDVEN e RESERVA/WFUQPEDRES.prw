...
Private lShow  := .F.
Private nReg   :=  0
Private cEmail :=  "cristiano.machado@imdepa.com.br;edivaldo@imdepa.com.br"
Private cLog   := ""
...
U_EnvMyMail('protheus@imdepa.com.br',cEmail,'','Ajuste B2_QPEDVEN e B2_RESERVA', _ENTER + _ENTER + "Foram Atualizados " + cValToChar(nReg) + ' Registros... ' + _ENTER  + _ENTER  + cLog ,'',.F.)//| U_EnvMyMail(De, Para, Copia, Assunto, Corpo, Anexo )
...
While !EOF()
	...
	cLog +=  _ENTER + Alltrim(QPR->AJUSTE) + _ENTER
