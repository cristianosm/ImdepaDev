...
Static Function DMsgens(aMens)//| Monta as Mensagens de Observacoes e Rodape
	*******************************************************************************
	...
	Local MsgRodape  := SuperGetMV("IM_MSROORC", .F., '[Emitido em '+ Dtoc(dEmisOrc) +' - Proposta Valida por 2 Dias - Serao Acrescida Despesa Bancaria por Duplicata ] - Visite nosso site WWW.IMDEPA.COM.BR', Nil )
