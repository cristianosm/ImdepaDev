...
// pesquisa parametro que contem as filiais a serem espelhadas...
SX6->( dbSetOrder( 1 ) )

If !SX6->( dbSeek( cFilAnt + 'MV_FILESP', .f. ) )
	SX6->( dbSeek( '  ' + 'MV_FILESP', .f. ) )
EndIf

// verifica se a filial atual deve ser espelhada...
If ( cFilAnt $ AllTrim( SX6->X6_CONTEUD ) )
...
Local aCpoNEsp := {'B1_FILIAL','B1_COD','B1_DATREF','B1_UPRC','B1_UCOM','B1_PICM','B1_CONINI',;
					...
					'B1_TOLER','B1_TSPLAN','B1_PICMRET','B1_PICMENT','B1_CURVAPR','B1_CURVA'} //| CHAMADO: 13311 - Replica CURVA IMDEPA

//Local aCpoNEsp := { 'B1_FILIAL','B1_COD'}
