...
/*****************************************************************************\
**---------------------------------------------------------------------------**
** FUNÇÃO   : IMDF110     | AUTOR :Expedito Mendonca Jr| DATA : 30/04/2003   **
**---------------------------------------------------------------------------**
** DESCRIÇÃO: Registro de quantidade ofertada e venda perdida                **
**---------------------------------------------------------------------------**
...
**---------------------------------------------------------------------------**
**Edivaldo Coordeiro|06/09/2006| Reestruturação da Rotina IMDF110 com a Nova **
**                  |          | Versao do Orçado X Ofertado                 **
**                  |          |                                             **
**Edivaldo Coordeiro|12/12/2006|Implementada a alimentacao do ZA0_PRECO      **
**                  |          |on-line no atendimento portanto, foi retirado**
**                  |          |a pesquisa ao SUB no schedule                **
**                  |          |                                             **
**Edivaldo Coordeiro|24/01/2007|Quantidade ofertada deve ser o minimo entre  **
**                  |          |a consulta e o saldo e não entre o SUB e o   **
**                  |          |Saldo.                                       **
\*---------------------------------------------------------------------------*/
*******************************************************************************
*******************************************************************************
