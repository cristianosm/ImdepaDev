...
//oFolder := TFolder():New(1,1,{"Armazem 01","Armazem 98 (Exclusivo Importação)" },{"oFl1","oFl2",},oDlg,,,,.T.,.F.,373,150)
  oFolder := TFolder():New(1,1,{"Armazem 01","Armazem 98 (Exclusivo Importação)","Armazem 02" },{"oFl1","oFl2","oFl3",},oDlg,,,,.T.,.F.,373,150)
...
@ 04,05  SAY 'Produto'     COLOR CLR_BLUE     PIXEL SIZE 35,08  of oFolder:aDialogs[3] PIXEL
@ 04,40  MSGET cProduto    COLOR CLR_BLUE     PIXEL SIZE 35,07  of oFolder:aDialogs[3] PIXEL WHEN .F.
@ 04,80  MSGET cDesc       COLOR CLR_BLUE     PIXEL SIZE 150,07 of oFolder:aDialogs[3] PIXEL WHEN .F.
@ 04,245 SAY 'Solicitação' COLOR CLR_BLUE     PIXEL SIZE 40,08  of oFolder:aDialogs[3] PIXEL
@ 16,05  SAY 'Destino'     COLOR CLR_BLUE     PIXEL SIZE 32,08  of oFolder:aDialogs[3] PIXEL
@ 16,40  MSGET cDestFil    COLOR CLR_BLUE     PIXEL SIZE 20,07  of oFolder:aDialogs[3] PIXEL WHEN .F.
@ 16,60  MSGET cNomFil     COLOR CLR_BLUE     PIXEL SIZE 60,07  of oFolder:aDialogs[3] PIXEL WHEN .F.
@ 16,130 SAY 'Necessidade' COLOR CLR_BLUE     PIXEL SIZE 45,08  of oFolder:aDialogs[3] PIXEL
@ 16,170 MSGET nQtd        COLOR CLR_BLUE     PIXEL SIZE 35,07  of oFolder:aDialogs[3] PIXEL WHEN .F. PICTURE '@E 9999999.99'
@ 16,245 MSGET cNumSol     COLOR CLR_BLUE     PIXEL SIZE 50,07  of oFolder:aDialogs[3] PIXEL WHEN .F.

@ 32,02  LISTBOX oList02 ;
FIELDS HEADERS   ' ','Fil Forn','Disponivel Transf', 'Saldo Atual', 'Saldo Disponivel', 'Consumo Medio', 'Dias Consumo' ;
SIZE 360,085 ;
PIXEL of oFolder:aDialogs[3] PIXEL  ;
ON dblClick(lConTrf := FValida(cDestFil,cNomFil,.T.,oList02:nAt),aList02:=SDTroca(oList02:nAt,aList02,nQtd),oList02:Refresh())
...
For nPos := 1 to 12
	...
	// preenche cabecalho com ultimos 12 meses...
	aAdd( oList02:aHeaders, Left( MesExtenso( aMeses[ nPos, 1 ] ), 3 ) + '/' + StrZero( aMeses[ nPos, 2 ], 4 ) )
...
// carrega as posicoes para o vetor listbox
aList02 := Array(0)
Do While !Eof() .and. cProduto == SB2->B2_COD .and. SB2->B2_LOCAL == '02'
	// atualiza o vetor de selecao
	// nao existe transferencia da filial para ela propria
	If cDestFil == SB2->B2_FILIAL
		dbSkip()
...
oList02:bLine:={|| {If(aList02[oList02:nAt, DEF_FLAG ],oOk,oNo),;
					aList02[oList02:nAt, DEF_FILIAL ],;
					aList02[oList02:nAt, DEF_SALDO ],;
					aList02[oList02:nAt, DEF_QATU ],;
					aList02[oList02:nAt, DEF_DISP ],;
					aList02[oList02:nAt, DEF_CONMED ],;
					aListAux[ oList02:nAt, 01 ], ;
					aListAux[ oList02:nAt, 02 ], ;
					aListAux[ oList02:nAt, 03 ], ;
					aListAux[ oList02:nAt, 04 ], ;
					aListAux[ oList02:nAt, 05 ], ;
					aListAux[ oList02:nAt, 06 ], ;
					aListAux[ oList02:nAt, 07 ], ;
					aListAux[ oList02:nAt, 08 ], ;
					aListAux[ oList02:nAt, 09 ], ;
					aListAux[ oList02:nAt, 10 ], ;
					aListAux[ oList02:nAt, 11 ], ;
					aListAux[ oList02:nAt, 12 ], ;
					aListAux[ oList02:nAt, 13 ] } }
oList02:Refresh()
...
If cLocEst=='01'
 ...
 ElseIf cLocEst=='02'
 cRetorno:=aList02
 Else  //O item nao possui estoque disponivel p/ transferencia , retorno o Array aList     
  cRetorno:=aList   
Endif
