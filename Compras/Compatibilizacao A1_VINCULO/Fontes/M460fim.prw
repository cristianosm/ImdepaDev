...
±±şPrograma  łM460FIM   şAutor  łRaul                ş Data ł  April/03   ş±±
±±ĚÍÍÍÍÍÍÍÍÍÍŘÍÍÍÍÍÍÍÍÍÍĘÍÍÍÍÍÍÍĎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍĘÍÍÍÍÍÍĎÍÍÍÍÍÍÍÍÍÍÍÍÍą±±
±±şDesc.     łPonto de entrada apos a gravacao de Nota fiscal             ş±±
±±ş          ł                                                            ş±±
±±şAlteracao łGravacao dos campos E1_ENDOSSO,E1_CREDICM E E1_REEM,        ş±±
±±ş          łcampos estes para filtro na geracao do bordero. (O rela-    ş±±
±±ş          łcionamento destes campos sao com o arquivo SUA.             ş±±
±±ş          łGravacao do lucro e margem nos arquivos SD2 e SE1           ş±±
...
±±łExpedito    ł06/04/06ł Verificacao de inconsistencia nas tabelas e     ł±±
±±ł            ł        ł geracao de log.                                 ł±±
±±łMarcioQ.Borgł19/09/07ł Ajuste na amarraçăo do itemSD2 com o acols      ł±±
±±łMarcioQ.Borgł20/05/08ł Desonera MC qdo Sit.Trib,considera icm retido   ł±±
±±ł            ł        ł                                                 ł±±
...
//removido em 26/02/2015 em funçăo de que as regras de comissăo por operador foram descontinuadas - Rodrigo Carvalho - Solutio
...
IF SF2->F2_FILIAL = '13'
   U__CORCOMIS() // Corrigi as comissőes de Curitiba com TES com percentual de icms diferido - Agostinho 23/03/2010
ENDIF
*/
...
//	SE2->( dbSeek( xFilial( 'SE2' ) + &( GetMv( "MV_2DUPREF" ) ) + SD2->D2_NFORI, .f. ) )
	IF !FOUND()  //  Compatiblizar para encontrar os titulos  gerados com os prefixos das filias, antes da alteraçăo do parametro MV_2DUPREF para SF1->F1_SERIE em 14/02/2013
...
//łatualizar dados da NF no atendimento do Call Center    	     ł
...
Endif
 ...
 // Edivaldo Gonlcalves Cordeiro  |Envio dos Boletins de Entrada
  If SF2->F2_CLIENTE==cImdepa .AND. SF4->F4_ESTOQUE = 'S' .AND. SF2->F2_TIPO $ 'ND'  //Nota de Transferęncia , avisa vendedores da entrada dos produtos na filial
  ...
  If SF2->F2_CLIENTE==GetMv('MV_IMDEPA')
...
//łDefine o desconto de ICMS padrao                     ł
...
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄż
//łGrava o campo especifico F2_FILCLI                   ł
//ŔÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄŮ
Reclock("SF2",.F.)
...
Do While  SD2->(!Eof()) .AND. SD2->D2_FILIAL == xFilial('SD2') .AND. SD2->D2_DOC == SF2->F2_DOC  .AND. SD2->D2_SERIE == SF2->F2_SERIE
	...
	nValmerc 	:= SF2->F2_VALMERC //VALOR TOTAL DAS MERCADORIAS COM ACRESCIMMO DA CONDIÇĂO DE PAGAMENTO
	...
	///
	nIdade2     := 0   //VARIAVEL PADRĂO PARA IDADE2




	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄż
	//łPosicionando Produtos         			     ł
	...
	//ş                        CUSTOS        (OBS: qualquer alteraçăo aqui, faça também no TMKVFIM        ş
	//ČÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍĽ


	//marcio
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄż
	//ł     CAMPANHAS DE VENDAS								ł
	//ŔÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄŮ
	//  nao precisa de campanha pois pego a meta direto do SC6

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄż
	//łCALCULO DAS COMISSOES  	  							ł
	//ŔÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄŮ
	...
	//Custo Margem de Contribuiçăo Reposicao
...
*/
  ...
  ENDIF
	...
	// ********** COMISSOES ***********************************
	// acrescer 63% ao valor do vendedor interno (comis1) em funçăo de incidęncia de encargos trabalhistas
   ...
   //	nVDescComis := nQtdItem * nVlrItem * ( (n_COMIS1 * 1.63)  + n_COMIS2 + (n_COMIS3 * 1.63)  + (n_COMIS4 * 1.63) + n_COMIS5)/100
	...
	// Margem de Contribuicao năo Gerencial (sem os fatores -> F1, F2, F3 ...)
...
//	nVDescComis := 	SD2->D2_QUANT  * SD2-> D2_PRCVEN * ( n_COMIS1  + n_COMIS2 + n_COMIS3  + n_COMIS4 + n_COMIS5 )/100
	//nVDescComis := nQtdItem * nVlrItem * ( (n_COMIS1 * 1.63)  + n_COMIS2 + (n_COMIS3 * 1.63)  + (n_COMIS4 * 1.63) + (n_COMIS5 * 1.63) )/100 // alterado por rodrigo soluto em 25/05/2015 em funçăo de que deve retornar a incidęncia de 63% de encargos trabalhistas no calculo de comissőes.
	...
	// Custo standart = 100,00 ( - ) % PIS ( - ) % Cofins ( - ) % ICMS do Estado de origem da venda (ESTE PERCENTUAL NESTA SITUAÇĂO, deve ser substituído pela alíquota de 4%
    // ( = ) Custo Reposiçăo
...
*/
    ...
    // Incluir o percentual de 8,25% no custo reposiçăo nas vendas que se enquadram na substituiçăo tributária para as filiais: RS , MT, PR, MG.
...
/*
    		...
    		elseIf cFilAnt =='09' .AND. cUfFilOrig =='SP'
		 	 ...
		 	 Endif
*/
 				If  (cFilAnt =='02' .AND. cUfFilOrig =='MT' .AND. SA1->A1_EST='MT' .AND. !(SB1->B1_GRUPO $ "0008") )
					//nCustoMCR  := nCustoMCR * 1.24    // Acrescimo Especifico para MT
				...
				elseIf cFilAnt =='14' .AND. cUfFilOrig =='MG' .AND. !(SB1->B1_GRUPO $ "0011*0014*0015*0008") .AND. SA1->A1_EST='MG'
					//nCustoMCR  := nCustoMCR * 1.44    // Acrescimo Especifico para MT
         	       nFATOR:=U_FCalcIMC(cFilAnt,cLocal,SB1->B1_ORIGER,SB1->B1_ORIGEM,SB1->B1_IPI)
				   nCustoMCR  := nCustoMCR * NFATOR    // Acrescimo Especifico para MT
				elseIf cFilAnt =='09' .AND. cUfFilOrig =='SP'
...
/*
    		 If cFilAnt =='02' .AND. cUfFilOrig =='MT'
			  nCustoMCR  := nCustoMCR * 1.24 // Acrescimo Especifico para MT
			 Endif
	   		 If cFilAnt =='14' .AND. cUfFilOrig =='MG'
			  nCustoMCR  := nCustoMCR * 1.44 // Acrescimo Especifico para MT
			 Endif
...
*/
          	...
          	If (cFilAnt =='02' .AND. cUfFilOrig =='MT' .AND. SF2->F2_EST='MT' .AND. !(SB1->B1_GRUPO $ "0008")) //.AND. SB1->B1_INDUSTR='N'
				//nCustoMCR  := nCustoMCR * 1.24 // Acrescimo Especifico para MT
...
//SB1->B1_GRUPO NOT $ "001*0014*0015"
			...
			If cFilAnt =='14' .AND. cUfFilOrig =='MG' .AND. !(SB1->B1_GRUPO $ "0011*0014*0015*0008") .AND. SF2->F2_EST='MG'  //.AND. SB1->B1_INDUSTR='N' ///QUAN INSDUSTRIAL FOR NAO
				//nCustoMCR  := nCustoMCR * 1.44 // Acrescimo Especifico para MT
			   //LEIO A TABELA BASEADO NO IPI
		       nFATOR:=U_FCalcIMC(cFilAnt,cLocal,SB1->B1_ORIGER,SB1->B1_ORIGEM,SB1->B1_IPI)
			   nCustoMCR  := nCustoMCR * NFATOR    // Acrescimo Especifico para MT
	...
	*/
	...
	//Indices da Margem de Contribuiçăo (DIVIDIR PELO VALOR TOTAL DA NOTA sem IPI, ou seja é igual a base de ICM )
	// Năo Gerencial
...
//	nIMCUC := U_ValMarg(nMCUC / (nTotItemSemIPI - SD2->D2_ICMSRET) * 100)
	...
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ@ż
	//łLog de variáveis para localizar diferença nos custosł
	//ŔÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ@Ů
		If lGeralog
...
±±łFuncao    łVERINCONS ł Autor ł Expedito Mendonca Jr  ł Data ł06/06/2006ł±±

±±ĂÄÄÄÄÄÄÄÄÄÄĹÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±łDescricao ł Faz a verificacao de inconsistencias entre as tabelas      ł±±
±±ł          ł SD2 e SC9 e, se houver, gera log. O objetivo desta funcao  ł±±
±±ł          ł eh identificar a origem de problemas na quantidade         ł±±
±±ł          ł reservada dos produtos (B2_RESERVA).                       ł±±
±±ĂÄÄÄÄÄÄÄÄÄÄĹÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±łSintaxe   ł VERINCONS()                                                ł±±
±±ĂÄÄÄÄÄÄÄÄÄÄĹÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
...
Else
	If Type("l410Auto") != "U" .And. !l410Auto
		//u_Mensagem("O desconto de ICMS padrăo para vendas com origem em "+cOrigem+" e destino "+cDestino+" năo está cadastrado.")
		Final("Erro ao gravar pedido de venda.")

		ConOut("O desconto de ICMS padrăo para vendas com origem em "+cOrigem+" e destino "+cDestino+" năo está cadastrado.")
...
//ł Armazena o estado de origem para calc da margemł
cUFOri := cOrigem
...
//|Data......: 13/05/2010
//|Descricao.: Atualiza comissăo por Operador na gravaçăo da Nota Fiscal
//|Observaçăo:
//+-----------------------------------------------------------------------------------//
*--------------------------------------------------*
...
If DbSeek(xFilial("SUA")+SC5->C5_NUMSUA)
   If Empty(SUA->UA_OPERAD2) .OR. SUA->UA_OPERAD2=SUA->UA_OPERADO .OR. SA1->A1_GERVEN <> '000685'   //-------Năo há dois operadores,portando năo precisa gerar a segunda comissăo.
	      Return
   Else
            ...
            IF SE3->( dbSeek( xFilial("SE3") + SE3->E3_PREFIXO + SE3->E3_NUM + SE3->E3_PARCELA + SE3->E3_SEQ +  cVendInt , .T. ) )
               ...
               cE3_BAIEMI := SE3->E3_BAIEMI
                ...
                SE3->( RecLock( 'SE3', .T. ) )
                    ...
                    //Identifico os percentuais de comissăo dos vendedores
                    ...
                    //Calcula Diferença da Comissăo entre o Cadastro(SA3) e Comissăo no Título SE3
                    nDifComis       := nE3PORC / nComVend1
                    nPerComVenda    := nComVend2 *nDifComis



               cSql :=" UPDATE "+RetSqlName("SE3")//--------------Atualiza a Base e o valor da Comissăo para os vendedores
	           cSql +=" SET "
               ...
               cSql :=" UPDATE "+RetSqlName("SE3")//--------Atualiza o Percentual e valor da comissăo para o vendedor2
	           cSql +=" SET "
	           cSql +=" E3_BASE = " + STR(SE3->E3_BASE  /2 )   + " ,  "
...
USER FUNCTION _CORCOMIS() // Faz a correcao da base e do valor das comissoes da filial de
                          ...
                          // Esse erro está ocorrendo no P8. No P10 năo ocorre.
                          // Essa funçăo deverá ser desativado no P10.
*****************************************************************************************
...
//|Descricao.: Retorna o percentual de comissăo para o 2ş Operador do Call Center
//|Uso.......: U_SendNfTrf
//|Observaçăo: Envia o e-mail dos Boletins de Entrada
//+-----------------------------------------------------------------------------------//
...
//|Descricao.: Carrega os itens de transferęncia para envio do Boletim de Entrada
//|Uso.......: U_SendNfTrf
//|Observaçăo: Envia o e-mail dos Boletins de Entrada
//+-----------------------------------------------------------------------------------//
